/**
 * T009: Contract test POST /api/auth/gmail/connect
 *
 * This test validates the API contract for initiating Gmail OAuth connection.
...
describe('/api/auth/gmail/connect - Contract Tests', () => {
  it('should return OAuth URL with correct schema', async () => {
    ...
    let handler: any
    try {
      handler = require('@/pages/api/auth/gmail/connect').default
    } catch (error) {
    ...
    // Should contain Google OAuth parameters
